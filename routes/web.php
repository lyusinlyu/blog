...
Route::get('/users/{user_id}/posts', 'UsersController@showPosts');
Route::get('/users/{user_id}/posts/{post_id}', 'UsersController@showPost');
Route::get('users/{user_id}/categories', 'UsersController@showCategories');
Route::get('users/{user_id}/categories/{category_id}', 'UsersController@showCategory');
